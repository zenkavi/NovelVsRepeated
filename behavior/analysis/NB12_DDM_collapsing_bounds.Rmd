...
optim_out = optim(par = start_vals, get_task_nll, data_= tmp, par_names_ = par_names, model_name_ = model)
...
```{r}
rm(annotations, cur_dat, dat, debug_out, sub_stims, tmp, cur_barrierDecay, cur_bias, cur_d, cur_dv, cur_nonDecisionTime, cur_sigma, cur_valDiff, cur_valRef, cur_valStim, decay_vals, i, n, cur_out, optim_out)
```
