...
For each subject
Is the effect of value difference growing across all time bins
Or does it only jump from day 1 to day 2 and then stay at that level?
Does this differ by stim type?
And task?
...
Do I want Helmert coding where I compare day 1 to later, day 2 to later etc. 
or forward difference coding where I compared day 1 to day 2, day 2 to day 3 etc?
