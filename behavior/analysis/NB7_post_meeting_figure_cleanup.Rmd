...
fixation duration ~ fixation type (1 = first, 2 = middle, 3 = last) * day * type --> linear effect of later fixations 
fixation duration ~ (fixation type ^ 2) * day * type --> quadratic effect of later fixations

number of fixations ~ (value difference^2) * day * type

logit(first fixation == left) ~ value difference * day * type

logit(choice == left) ~ first fixation side * value difference * day * type

logit(choice == left) ~ lastt fixation side * value difference * day * type
