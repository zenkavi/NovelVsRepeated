...
Accuracy plot for each HT stim
(preferably with each HT stim in the plot as well)
...
for(i in 1:length(subs)){
  ...
  ggsave(file=paste0(fig_out_path, 'yn_sub-',cur_sub,'_meanLogRTOverDays.jpg'), p, height = 8, width=12, units="in")  
}
